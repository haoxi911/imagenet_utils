...
def create_image_lists(image_dir):
  ...
  for sub_dir in sub_dirs:
    ...
    for extension in extensions:
      file_glob = os.path.join(image_dir, dir_name, 'training', '*.' + extension)
      training_files.extend(gfile.Glob(file_glob))
      file_glob = os.path.join(image_dir, dir_name, 'validation', '*.' + extension)
      validation_files.extend(gfile.Glob(file_glob))
      file_glob = os.path.join(image_dir, dir_name, 'testing', '*.' + extension)
